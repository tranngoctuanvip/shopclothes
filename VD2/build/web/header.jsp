<%-- 
    Document   : header
    Created on : Jun 30, 2021, 11:09:46 AM
    Author     : Admin
--%>
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="list.jsp"><img src="images/home/logo.png" alt="" /></a>
						</div>
					...
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								<li><a href="list.jsp" class="active">Home</a></li>
