<%-- 
    Document   : detail
    Created on : Jun 30, 2021, 10:48:20 AM
    Author     : Admin
--%>
					...
					<div class="product-details"><!--product-details-->
						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								<img src="images/home/<%=sp.getHinh_anh()%>" class="newarrival" alt="" />
                                                                <h2><%=sp.getTen_san_pham()%></h2>
                                                        <p><%=sp.getMo_ta()%></p>								
								<span>
                                                                    <span><%=sp.getDon_gia()%> VNĐ</span>
									<a type="button" class="btn btn-fefault cart" href="GioHangServlet?command=insert&ma_san_pham=<%=sp.getMa_san_pham()%>&cartID=<%=System.currentTimeMillis()%>">
